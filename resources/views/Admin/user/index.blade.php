<x-admin.admin-layout title="Tài khoản">
    <div class="d-flex">
            ...
            <div class="card mb-0">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.user.index') }}">
                        <div class="row">
                            <div class="col-md-4">
                                <x-input name="username" label="Tên đăng nhập" value="{{ $username }}" />
                            </div>
                            <div class="col-md-4">
                ...
                <tr>
                    ...
                    <td class="fit">
                        ...
                        <a href="{{ route('admin.user.delete', ['id' => $item->id]) }}" class="btn btn-outline-danger"
                           onclick="return confirm('Xác nhận xóa tài khoản [{{ $item->username }}]?')">
