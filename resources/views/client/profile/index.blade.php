<x-client.client-layout title="Trang cá nhân - {{ $data->full_name }}">
    <form action="{{ route('profile.save', ['id' => $data->id]) }}" method="post" class="mb-3" autocomplete="off"
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <x-input name="phone_number" placeholder="Phone number" label="Số điện thoại" required
                         value="{{ $data->phone_number }}"/>
                <x-textarea name="address" placeholder="Địa chỉ" label="Địa chỉ" required value="{{ $data->address }}"/>
