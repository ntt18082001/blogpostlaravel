                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ route('account.logout') }}">
                            <i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle"
                                                                                                    data-key="t-logout">Đăng xuất</span>
                        </a>
                    </div>
                @else
                    <a href="{{ route('account.login') }}"
                       class="btn btn-link fw-medium text-decoration-none text-dark">Đăng nhập</a>
                    <a href="{{ route('account.register') }}" class="btn btn-primary">Đăng ký</a>
                @endif
            </div>
        </div>
    </div>
